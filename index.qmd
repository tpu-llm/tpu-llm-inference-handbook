...
Run the script (or use the git repo code/matrix_heartbeat_tpu.py) from the TPU VM's terminal:

```bash
(vm)$ python matrix_heartbeat_tpu.py
```
...
Average time per iteration: 38.8134 ms
```
